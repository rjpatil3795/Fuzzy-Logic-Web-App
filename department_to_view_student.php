...
<body>
    ...
    <div class = "container text-center mt-4">
            ...
            <select style="margin-left: 15px; margin-right: 15px" name="DepartmentStudent" class = "department" id="department">
            ...
            <select style="margin-left: 15px; margin-right: 15px" name="SemesterStudent" id="Semester">
    ...
    <?php
        ...
        {
            $getDepartment = $_POST['DepartmentStudent'];
            $_SESSION['DepartmentStudent'] = $getDepartment;
            $getSemester = $_POST['SemesterStudent'];
            $_SESSION['SemesterStudent'] = $getSemester;
