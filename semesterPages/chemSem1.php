...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO `chemsem1`(`Name`, `PHYSICS`, `CHEMISTRY`, `M1`, `CP`, `EGR`, `ETT`,`EXTRA`, `TOTAL`, `FUZZY`, `GRADE`, `REMARKS`, `CGPA`) VALUES ('$Name','$PHYSICS','$CHEMISTRY','$M1','$CP','$EGR','$ETT','$EXTRA','$TotalMarks','$Fuzzy','$Grade','$Remark','$CGPA')";
