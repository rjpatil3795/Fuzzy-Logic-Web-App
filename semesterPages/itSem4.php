...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO `itsem4`(`Name`, `AM`, `DS`, `MINOR_PROJECT`, `DBMS`, `EVS`, `SE`, `EXTRA`, `TOTAL`, `FUZZY`, `GRADE`, `REMARK`, `CGPA`) VALUES ('$Name','$PHYSICS','$CHEMISTRY','$M1','$CP','$EGR','$ETT','$EXTRA','$TotalMarks','$Fuzzy','$Grade','$Remark','$CGPA')";
		...
		<form action="<?php $_SERVER['PHP_SELF']?>" method="POST">	
			...
			<div>				
				...
				<table  class="table" border="1">
					...
					<tr><td>AM</td><td><input name = "PHYSICS_IA" type="text" id="txtPHYSICS_IA"></td> <td><input name = "PHYSICS_MSE" type="text" id="txtPHYSICS_MSE"></td> <td><input name = "PHYSICS_ESE" type="text" id="txtPHYSICS_ESE"></td> <td><input name = "PHYSICS"  type="text" id="txtPHYSICS" readonly></td></tr>
					<tr><td>DS</td><td><input name = "CHEMISTRY_IA" type="text" id="txtCHEMISTRY_IA"></td> <td><input name = "CHEMISTRY_MSE" type="text" id="txtCHEMISTRY_MSE"></td> <td><input name = "CHEMISTRY_ESE" type="text" id="txtCHEMISTRY_ESE"></td> <td><input  name = "CHEMISTRY" type="text" id="txtCHEMISTRY" readonly></td></tr>
					...
					<tr><td>DBMS</td><td><input name = "CP_IA" type="text" id="txtCP_IA"></td> <td><input name = "CP_MSE" type="text" id="txtCP_MSE"></td> <td><input name = "CP_ESE" type="text" id="txtCP_ESE"></td> <td><input name = "CP" type="text" id="txtCP" readonly></td></tr>				
					<tr><td>EVS</td><td><input name = "EGR_IA" type="text" id="txtEGR_IA"></td> <td><input name = "EGR_MSE" type="text" id="txtEGR_MSE"></td> <td><input name = "EGR_ESE" type="text" id="txtEGR_ESE"></td> <td><input name = "EGR" type="text" id="txtEGR" readonly></td></tr>
					<tr><td>SE</td><td><input name = "ETT_IA" type="text" id="txtETT_IA"></td> <td><input name = "ETT_MSE" type="text" id="txtETT_MSE"></td> <td><input name = "ETT_ESE" type="text" id="txtETT_ESE"></td> <td><input name = "ETT" type="text" id="txtETT" readonly></td></tr>				
