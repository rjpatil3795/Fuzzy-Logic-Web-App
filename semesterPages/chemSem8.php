		...
		<form action="<?php $_SERVER['PHP_SELF']?>" method="POST">	
			...
			<div>				
				...
				<table  class="table" border="1">
					...
					<tr><td>CPT</td><td><input name = "PHYSICS_IA" type="text" id="txtPHYSICS_IA"></td> <td><input name = "PHYSICS_MSE" type="text" id="txtPHYSICS_MSE"></td> <td><input name = "PHYSICS_ESE" type="text" id="txtPHYSICS_ESE"></td> <td><input name = "PHYSICS"  type="text" id="txtPHYSICS" readonly></td></tr>
					...
					<tr><td>BT</td> <td><input name = "M1_IA" type="text" id="txtM1_IA"></td> <td><input name = "M1_MSE" type="text" id="txtM1_MSE"></td> <td><input name = "M1_ESE" type="text" id="txtM1_ESE"></td> <td><input name = "M1" type="text" id="txtM1" readonly></td></tr>
					<tr><td>PII</td><td><input name = "CP_IA" type="text" id="txtCP_IA"></td> <td><input name = "CP_MSE" type="text" id="txtCP_MSE"></td> <td><input name = "CP_ESE" type="text" id="txtCP_ESE"></td> <td><input name = "CP" type="text" id="txtCP" readonly></td></tr>				
