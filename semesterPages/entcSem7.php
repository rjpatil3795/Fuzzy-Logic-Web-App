...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO `entcsem7`(`Name`, `VLSI_DESIGN`, `PROJECT2`, `JAVA`, `INTERNSHIP`, `ML`, `SOC_ARCHITECTURE`, `SOCIOLOGY`,`EXTRA`, `TOTAL`, `FUZZY`, `GRADE`, `REMARKS`, `CGPA`) VALUES ('$Name','$PHYSICS','$CHEMISTRY','$M1','$CP','$EGR','$ETT','$CSS','$EXTRA','$TotalMarks','$Fuzzy','$Grade','$Remark','$CGPA')";
...
<html>
	<head>
		...
		function getReport(){
					...
					var totalMarks = (PHYSICS_MARKS - (- CHEMISTRY_MARKS) - (- M1_MARKS) - (- CP_MARKS)- (- EGR_MARKS) - (-ETT_MARKS) - (- CSS_MARKS) - (-EXTRA_MARKS)).toFixed(2);
					
					//get the average marks
					var averageMarks = ((totalMarks / 8)/100).toFixed(2);					
		...
		<form action="<?php $_SERVER['PHP_SELF']?>" method="POST">	
			...
			<div>				
				...
				<table  class="table" border="1">
					...
					<tr><td>VLSI DESIGN</td><td><input name = "PHYSICS_IA" type="text" id="txtPHYSICS_IA"></td> <td><input name = "PHYSICS_MSE" type="text" id="txtPHYSICS_MSE"></td> <td><input name = "PHYSICS_ESE" type="text" id="txtPHYSICS_ESE"></td> <td><input name = "PHYSICS"  type="text" id="txtPHYSICS" readonly></td></tr>
					<tr><td>PROJECT 2</td><td><input name = "CHEMISTRY_IA" type="text" id="txtCHEMISTRY_IA"></td> <td><input name = "CHEMISTRY_MSE" type="text" id="txtCHEMISTRY_MSE"></td> <td><input name = "CHEMISTRY_ESE" type="text" id="txtCHEMISTRY_ESE"></td> <td><input  name = "CHEMISTRY" type="text" id="txtCHEMISTRY" readonly></td></tr>
					<tr><td>PROGRAMMING IN JAVA</td> <td><input name = "M1_IA" type="text" id="txtM1_IA"></td> <td><input name = "M1_MSE" type="text" id="txtM1_MSE"></td> <td><input name = "M1_ESE" type="text" id="txtM1_ESE"></td> <td><input name = "M1" type="text" id="txtM1" readonly></td></tr>
					<tr><td>INTERNSHIP</td><td><input name = "CP_IA" type="text" id="txtCP_IA"></td> <td><input name = "CP_MSE" type="text" id="txtCP_MSE"></td> <td><input name = "CP_ESE" type="text" id="txtCP_ESE"></td> <td><input name = "CP" type="text" id="txtCP" readonly></td></tr>				
					<tr><td>MACHINE LEARNINH</td><td><input name = "EGR_IA" type="text" id="txtEGR_IA"></td> <td><input name = "EGR_MSE" type="text" id="txtEGR_MSE"></td> <td><input name = "EGR_ESE" type="text" id="txtEGR_ESE"></td> <td><input name = "EGR" type="text" id="txtEGR" readonly></td></tr>
					<tr><td>SOC ARCHITECTURE</td><td><input name = "ETT_IA" type="text" id="txtETT_IA"></td> <td><input name = "ETT_MSE" type="text" id="txtETT_MSE"></td> <td><input name = "ETT_ESE" type="text" id="txtETT_ESE"></td> <td><input name = "ETT" type="text" id="txtETT" readonly></td></tr>				
					<tr><td>SOCIOLOGY</td><td><input name = "CSS_IA" type="text" id="txtCSS_IA"></td> <td><input name = "CSS_MSE" type="text" id="txtCSS_MSE"></td> <td><input name = "CSS_ESE" type="text" id="txtCSS_ESE"></td> <td><input name = "CSS" type="text" id="txtCSS" readonly></td></tr>				
