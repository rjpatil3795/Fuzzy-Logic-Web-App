...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO `elecsem2`(`Name`, `EEE`, `LC`, `M2`, `AM`, `DT`, `LC2`,`EXTRA`, `TOTAL`, `FUZZY`, `GRADE`, `REMARKS`, `CGPA`) VALUES ('$Name','$PHYSICS','$CHEMISTRY','$M1','$CP','$EGR','$ETT','$EXTRA','$TotalMarks','$Fuzzy','$Grade','$Remark','$CGPA')";
