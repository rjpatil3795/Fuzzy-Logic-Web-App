...
<body>
    ...
    <div class = "container text-center mt-4">
            ...
            <select style="margin-left: 15px; margin-right: 15px" name="DepartmentPie" class = "department" id="department">
            ...
            <select style="margin-left: 15px; margin-right: 15px" name="SemesterPie" id="Semester">
    ...
    <?php
        ...
        {
            $getDepartment = $_POST['DepartmentPie'];
            $_SESSION['DepartmentPie'] = $getDepartment;
            $getSemester = $_POST['SemesterPie'];
            $_SESSION['SemesterPie'] = $getSemester;
            $department_config = $getDepartment;
            $semester_config = $getSemester;
           
            echo $department_config;
            echo $semester_config;
            header("Location: view_pie.php"); 
        }
    ?>
</body>
